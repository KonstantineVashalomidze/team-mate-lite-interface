...
const Main = () => {
    const teamState = useSelector(state => state);
            ...
            <div className="main-container">
                ...
                <div className="main-container-middle">
                    <div className="main-container-middle-topbar">
                        <ChatTopBar image={
                            "https://scontent.ftbs6-2.fna.fbcdn.net/v/t39.30808-1/410162403_373859271687146_573242829385952404_n.jpg?stp=c0.0.100.100a_dst-jpg_p100x100&_nc_cat=105&ccb=1-7&_nc_sid=5f2048&_nc_ohc=UcyEcZ5xiDcAX-qbi4T&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.ftbs6-2.fna&oh=00_AfCQ_hj2m2CDXQoECAHTePEo4l1paHBmpO8_mwPnT3scQw&oe=660F1E22"} status={"Active"} name={"Luka Gogiashvili"}
                        />
                    </div>
